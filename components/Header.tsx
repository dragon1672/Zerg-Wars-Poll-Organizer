...
const Header: React.FC<HeaderProps> = ({ onAddPoll, onExport, onSaveProject, onTriggerLoad, onDeleteAll }) => {
    return (
        <header className="p-4 bg-white shadow-md mb-4 sticky top-0 z-20">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                ...
                <div className="flex flex-wrap space-x-3 mt-4 md:mt-0 items-center">
